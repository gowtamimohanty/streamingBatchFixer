...
inp_csv_file_path = os.path.join(current_directory, "transactionTotalstring_batch_path1.csv")
# Create the full path for the CSV file
out_csv_file_path = os.path.join(current_directory, "failedBatchesData_transactionTotalstring_path1.json")
