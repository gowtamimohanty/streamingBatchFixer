...
inp_csv_file_path = os.path.join(current_directory, "transactionTotalNull_5records.csv")
# Create the full path for the CSV file
out_csv_file_path = os.path.join(current_directory, "xdm_entities_test1.json")
...
with open(inp_csv_file_path,mode ='r') as file:
    ...
    with open(out_csv_file_path, "w", newline="\n") as csvfile:
