...
inp_csv_file_path = os.path.join(current_directory, "transactionTotalNull_batch_path2.csv")
# Create the full path for the CSV file
#out_csv_file_path = os.path.join(current_directory, "failedBatchesData_tranTotalNull_path2.csv")
out_csv_file_path = os.path.join(current_directory, "failedBatchesData_tranTotalNull_path2_onlydata.json")
